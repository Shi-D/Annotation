...
public class BaseGridAction extends BaseAction
{
	...
	protected FilterSearch getFilter()
	{
		...
		{
			List<Sorter> sorterList = GsonUtil.gson.fromJson(sorters, new TypeToken<List<Sorter>>(){}.getType());
	...
	private boolean isSuperAdmin() {
		return false;
	}                                 //该系统没有超级管理员，若后期需要，则删除此项然后进入BaseAction修改
